...
import pokebola2 from '../assets/pokebola3.gif';
...
const Pokedex = () => {
    ...
    if (pagesNumbers.length >= maxPageNumberLimit) {
        pageDecrementBtn = (
            <button onClick={handlePrevbtn} disabled={page <= pageNumberLimit}>
                {' '}
                &hellip;
            </button>
        );
        ...
        <div className={`pokedex ${theme ? 'open' : ''} `}>
            ...
            <div className={`menu ${isMenu ? 'input' : ''} `}>
                ...
                <div className="config-block">
                    <Link to={'/pokedex/config'} className="link-config">
                        <hr />
                ...
                <img className="pokebola2" src={pokebola2} alt="" />
            </div>
