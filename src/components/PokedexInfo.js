    ...
    return (
        ...
        <div className="poke-info">
            ...
            <div className="one-info">
                <img src={pokemon.sprites?.other["official-artwork"].front_default} className="poke-img" alt="" />
            ...
            <div className="stats-base">
                ...
                <div className="progress-bar">
                    <div className="content" style={{width:`${pokemon.stats?.[0]?.base_stat/1.5}%`}}>{pokemon.stats?.[0]?.base_stat}/150</div>
                </div>

                <p><b>Speed: </b></p>
                <div className="progress-bar">
                    <div className="content" style={{width:`${pokemon.stats?.[5]?.base_stat/1.5}%`}}>{pokemon.stats?.[5]?.base_stat}/150</div>
                    </div>

                <p><b>Deffense: </b></p>
                <div className="progress-bar">
                    <div className="content" style={{width:`${pokemon.stats?.[1]?.base_stat/1.5}%`}} >{pokemon.stats?.[1]?.base_stat}/150</div>
                </div>

                <p><b>Atack: </b> </p>
                <div className="progress-bar">
                    <div className="content" style={{width:`${pokemon.stats?.[2]?.base_stat/1.5}%`}}>{pokemon.stats?.[2]?.base_stat}/150</div>
                </div>
